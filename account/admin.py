...
class AccountAdmin(UserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'phone', 'date_joined', 'is_admin', 'is_staff', 'is_active','type')
...
admin.site.register(FranchiseeOwners)
admin.site.register(PilotCertificates)
