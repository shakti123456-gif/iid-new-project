...
urlpatterns = [
    ...
    path("CheckoutView_subscription/<str:pk>/",CheckoutView_subscription.as_view(),name="CheckoutView_subscription"),
    path('certificationform',Domptest,name="Domptest"),
    path('subscription/order',successsubcription,name="order.success1")
